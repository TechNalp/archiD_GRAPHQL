...
class ShowtimeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSchedule = channel.unary_stream(
                ...
                request_serializer=showtime__pb2.ScheduleEmpty.SerializeToString,
...
def add_ShowtimeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSchedule': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=showtime__pb2.ScheduleEmpty.FromString,
...
class Showtime(object):
    ...
    def GetSchedule(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/Showtime/GetSchedule',
            showtime__pb2.ScheduleEmpty.SerializeToString,
